...
class HandDataset(BaseDataSet):
    def __init__(self,**kwargs):
        self.num_classes = 2 
        self.palette = palette.hand_palette 
        self.id_to_trainId = ID_TO_TRAINID 
        super(HandDataset,self).__init__(**kwargs)
...
class Hand(BaseDataLoader):
    def __init__(self, data_dir, batch_size, split, crop_size=None, base_size=None, scale=True, num_workers=0, val=False,
        ...
        self.dataset = HandDataset(**kwargs)
        super(Hand, self).__init__(self.dataset, batch_size, shuffle, num_workers, val_split)
